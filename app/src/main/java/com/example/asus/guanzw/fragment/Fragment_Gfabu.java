...
public class Fragment_Gfabu extends Fragment {
    private RecyclerView recycle_view;
    private List<Integer> listimage= new ArrayList<>();
    private List<String> listtext= new ArrayList<>();
    private LinearLayout weilogin;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=View.inflate(getActivity(), R.layout.frag_gfabu,null);
        recycle_view = view.findViewById(R.id.recycle_view);
        weilogin = view.findViewById(R.id.weilogin);
        return view;
    }
